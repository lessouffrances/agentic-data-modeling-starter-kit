...
- [ ] Code works as described in the feature or modeling request
- [ ] No lint or type errors in changed files (run the appropriate lint/type-check for this stack)
- [ ] Tests or checks exist for new logic (e.g. model validation, migration tests, data quality checks) if a test framework is configured
