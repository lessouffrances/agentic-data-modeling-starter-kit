...
## SPEC.md Updates
1. Find the feature or modeling section matching what you just built
...
Add an entry when:
- A new library, warehouse, or modeling pattern is introduced
- An architectural pattern for data modeling or pipelines is chosen
